package fragmenttrasitionextend;
...
import com.easysoft.widget.fragment.FragmentTransactionExtended;


public class FragmentDyActivity extends FragmentActivity implements AdapterView.OnItemSelectedListener{
...
//        fragmentTransaction.commit();
        ...
        bundle.putInt(FragmentHelper.AnimationsType,optionSelected);

        FragmentHelper.showFrag(this,R.id.fragment_place,  mFirstFragment,bundle);
    }
...
//            fragmentTransactionExtended.commit();
            ...
            FragmentHelper.showFrag(this,R.id.fragment_place,  secondFragment,bundle);
        }else{
