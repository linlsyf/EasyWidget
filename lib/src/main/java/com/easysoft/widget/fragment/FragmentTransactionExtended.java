...
public class FragmentTransactionExtended  implements FragmentManager.OnBackStackChangedListener  {
    ...
    private void switchFragments() {
        ((FragmentActivity) this.mContext).getFragmentManager().addOnBackStackChangedListener((android.app.FragmentManager.OnBackStackChangedListener)this);
    ...
    public void slideForward() {
        ...
        s.start();
        ((FragmentActivity) this.mContext).getFragmentManager().removeOnBackStackChangedListener((android.app.FragmentManager.OnBackStackChangedListener)this);
    }
