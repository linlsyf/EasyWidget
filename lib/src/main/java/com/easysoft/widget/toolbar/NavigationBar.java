...
//        mDrawLine = true;
    ...
    private void initRootView() {
        mRootView = View.inflate(mContext, R.layout.view_navigationbar, null);
        addView(mRootView);
    ...
    private void changeCenterLayout() {
        post(new Runnable() {
            ...
            public void run() {
                ...
                MarginLayoutParams rfParams = (MarginLayoutParams) rightFirst.getLayoutParams();
...
//    }
    ...
    public void setEnableByLoaction(Location location, boolean enable) {
    ...
    private View createOnlyImage(NavigationBarBean bean) {
        Drawable image = bean.getDrawable();
        if (image == null) {
            image = mContext.getResources().getDrawable(bean.getDrawableID());
            if (image == null) {
    ...
    private static Bitmap zoomDrawableToBitmap(Drawable drawable, float scale) {
        Bitmap bitmap = BitmapUtil.DrawableUtil.drawableToBitmap(drawable);
        return BitmapUtil.zoomBitmap(bitmap, scale);
    }
